...
int redpin   = 23; //select the pin for the red LED
...
void changeColor(){
    if (((millis()%70000) < 10000)&&(color != String('violet'))){
    analogWrite(redpin, 143); // Violet
    analogWrite(greenpin, 0);
    analogWrite(bluepin, 255);
    printChange();
    color = String('violet');
  } else if (((millis()%70000) >= 10000)&&((millis()%70000) < 20000)&&(color != String('blue'))){
    analogWrite(redpin, 0); // Blue
    analogWrite(greenpin, 0);
    analogWrite(bluepin, 255);
    printChange();
    color = String('blue');
  } else if (((millis()%70000) >= 20000)&&((millis()%70000) < 30000)&&(color != String('cyan'))){
    analogWrite(redpin, 0); // Cyan
    analogWrite(greenpin, 255);
    analogWrite(bluepin, 255);
    printChange();
    color = String('cyan');
  } else if (((millis()%70000) >= 30000)&&((millis()%70000) < 40000)&&(color != String('green'))){
    analogWrite(redpin, 0); // Green
    analogWrite(greenpin, 128);
    analogWrite(bluepin, 0);
    printChange();
    color = String('green');
  } else if (((millis()%70000) >= 40000)&&((millis()%70000) < 50000)&&(color != String('yellow'))){
    analogWrite(redpin, 255); // Yellow
    analogWrite(greenpin, 255);
    analogWrite(bluepin, 0);
    printChange();
    color = String('yellow');
  } else if (((millis()%70000) >= 50000)&&((millis()%70000) < 60000)&&(color != String('orange'))){
    analogWrite(redpin, 255); // Orange
    analogWrite(greenpin, 165);
    analogWrite(bluepin, 0);
    printChange();
    color = String('orange');
  } else if (((millis()%70000) >= 60000)&&((millis()%70000) < 70000)&&(color != String('red'))){
